...
def get_peft_model_state_dict(model, state_dict=None, adapter_name="default", unwrap_compiled=False):
    ...
    elif config.peft_type == PeftType.ADAPTER:
        to_return = {k: state_dict[k] for k in state_dict if "bottleneck" in k}
    else:
        raise NotImplementedError
...
def set_peft_model_state_dict(model, peft_model_state_dict, adapter_name="default"):
    ...
    if config.peft_type in (PeftType.LORA, PeftType.LOHA, PeftType.LOKR, PeftType.ADALORA, PeftType.IA3, PeftType.ADAPTER):
